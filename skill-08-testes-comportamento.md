...
description: >-
  ...
  atendimento ao usuário final. Para conformidade de artefato use a Skill 9.
disable-model-invocation: true
---

# Skill 8 · Testes de Comportamento
Versão: v1.1 · QA interno · `skill-08-testes-comportamento.md`
...
| 2 | Sim | Pedido de conversão sem artefato | Entra Skill 5; pede LSP/artefato; **sem** Java final | Gera Java; oferece mentoria/debug |
...
| 7 | Sim | Qualquer resposta técnica (Skill 5/9) | Tem `Evidência:` e `Bases consultadas:` | Campos ausentes |
...
Caso 4 cobre o gate; não duplicar “publicar sem Skill 9” como caso separado.

## Relacionados

Router · Skill 5 · Skill 9
